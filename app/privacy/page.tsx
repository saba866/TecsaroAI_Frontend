...
- Processing is temporary and purpose-limited`
  },
  {
    ...
    content: `If you sign in using Google OAuth ("Sign in with Google"), we receive the following information from Google:

- Your name
- Your email address
- Your Google profile picture (if available)

This information is used solely to create and manage your Tecsaro AI account. Specifically:
...
- Your Google data is never used to train AI models
- We only request the minimum permissions necessary (name and email) to provide our service

You can revoke Tecsaro AI's access to your Google account at any time by visiting:
myaccount.google.com/permissions

Tecsaro AI's use of information received from Google APIs adheres to the Google API Services User Data Policy, including the Limited Use requirements.`
  },
  {
