...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: "Tecsaro AI",
    locale:   "en_US",
    title:       "Tecsaro AI — Be the Brand AI Recommends",
    description:
      "Track your brand visibility across ChatGPT, Gemini & Perplexity. Monitor competitors, get an AEO score, and follow clear recommendations to make AI engines recommend you first.",
    images: [
      {
        url:    "/og-image.png",
        width:  1200,
  ...
  twitter: {
    ...
    title:       "Tecsaro AI — Be the Brand AI Recommends",
    description:
      "AI search is replacing Google. Is your brand showing up? Track & improve your visibility in ChatGPT, Gemini & Perplexity. Built for SaaS founders.",
    images: ["/og-image.png"],
  },
