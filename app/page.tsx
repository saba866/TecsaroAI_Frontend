      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            operatingSystem: "Web",
            description:
              "AEO platform that tracks brand visibility in ChatGPT, Gemini, and Perplexity. Monitor AI mentions, detect competitors, and improve your AEO score.",
            offers: [
              {
                "@type": "Offer",
                name: "Free Plan",
                price: "0",
                priceCurrency: "INR",
                description: "1 brand, 10 prompts, 3 competitors, Gemini only, forever free",
              ...
              },
              {
                ...
                price: "2999",
                priceCurrency: "INR",
                description: "1 brand, 20 prompts, 10 competitors, ChatGPT & Gemini",
              ...
              },
              {
                ...
                price: "7999",
                priceCurrency: "INR",
                description: "3 brands, 50 prompts, 15 competitors, ChatGPT + Gemini + Perplexity + AI Citations",
                url: "https://ai.tecsaro.com/pricing",
              },
            ],
            featureList: [
