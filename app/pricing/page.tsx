...
//     monthly: { price: "₹6,900",    sub: "/month" },
//     yearly:  { price: "₹69,000",   sub: "/year", perMonth: "₹5,750/mo", savings: "2 months free" },
//     trial: "7-day free trial", highlighted: false,
//     features: [
//       "1 brand / website", "Up to 50 prompts generated", "Select up to 20 prompts to track",
//       "Track up to 10 competitors", "Website pages crawled", "Daily AI visibility tracking",
//       "ChatGPT, Gemini", "AEO Visibility Score", "Recommendations", "Schema generation", "Email support",
//     ],
...
//     monthly: { price: "₹20,900",   sub: "/month" },
//     yearly:  { price: "₹2,09,000", sub: "/year", perMonth: "₹17,417/mo", savings: "2 months free" },
//     trial: "7-day free trial", highlighted: true,
//     features: [
//       "Up to 3 brands / websites", "Up to 300 prompts generated", "Select up to 50 prompts to track per brand",
//       "Track up to 15 competitors per brand", "Websites pages crawled", "Daily AI visibility tracking",
//       "ChatGPT, Gemini & Perplexity", "AEO Visibility Score", "Advanced recommendations",
//       "Schema generation", "Exportable reports", "Priority support",
//     ],
//     cta: "Start Free Trial",
//   },
// ]
...
//               className={`px-6 py-2 rounded-full text-sm font-medium transition-all ${billingPeriod === "monthly" ? "bg-emerald text-charcoal" : "text-gray-400 hover:text-white"}`}>
//               Monthly
//             </button>
//             <button onClick={() => setBillingPeriod("yearly")}
//               className={`px-6 py-2 rounded-full text-sm font-medium transition-all flex items-center gap-2 ${billingPeriod === "yearly" ? "bg-emerald text-charcoal" : "text-gray-400 hover:text-white"}`}>
//               Yearly
//               <span className="text-xs px-2 py-0.5 rounded-full bg-amber text-charcoal font-semibold">2 months free</span>
//             </button>
//           </div>
//         </div>
//       </section>
...
//               return (
//                 <div key={plan.name} className={`relative rounded-2xl p-8 ${plan.highlighted ? "bg-charcoal text-white ring-2 ring-emerald" : "bg-white border border-gray-200"}`}>
//                   {plan.highlighted && (
...
//                   <div className="mb-6">
//                     <h3 className={`font-heading text-xl font-bold mb-1 ${plan.highlighted ? "text-white" : "text-charcoal"}`}>{plan.name}</h3>
//                     <p className={`text-sm mb-2 ${plan.highlighted ? "text-gray-400" : "text-graphite"}`}>{plan.description}</p>
//                     <span className={`text-xs font-medium px-2 py-1 rounded-full ${plan.highlighted ? "bg-emerald/20 text-emerald" : "bg-emerald/10 text-emerald"}`}>
...
//                       <span className={`font-mono text-4xl font-bold transition-all ${plan.highlighted ? "text-white" : "text-charcoal"}`}>
//                         {pricing.price}
//                       </span>
//                       <span className={plan.highlighted ? "text-gray-400" : "text-graphite"}>{pricing.sub}</span>
//                     </div>
//                     {"perMonth" in pricing && (
...
//                     className={`w-full h-12 font-semibold ${plan.highlighted ? "bg-emerald hover:bg-emerald/90 text-charcoal" : "bg-charcoal hover:bg-charcoal/90 text-white"}`}
//                   >
//                     {plan.cta}
//                   </Button>
...
//                         <span className={`text-sm ${plan.highlighted ? "text-gray-300" : "text-graphite"}`}>{feature}</span>
//                       </li>
//                     ))}
//                   </ul>
//                 </div>
...
//         <div className="mx-auto max-w-7xl px-6 lg:px-8">
//           <h2 className="font-heading text-2xl sm:text-3xl font-bold text-charcoal text-center mb-12">Compare Plans</h2>
...
//                 <div className="w-8 h-8 rounded-full bg-emerald/10 text-emerald font-bold text-sm flex items-center justify-center mb-3">{item.step}</div>
...
//             <Link href="/faq">
//               <Button variant="outline" className="border-charcoal text-charcoal hover:bg-charcoal hover:text-white bg-transparent">View FAQ</Button>
//             </Link>
//             <Link href="mailto:support@tecsaro.com">
//               <Button className="bg-charcoal hover:bg-charcoal/90 text-white">Contact Us</Button>
//             </Link>
//           </div>
//         </div>
//       </section>
