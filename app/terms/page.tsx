...
const sections = [
  {
    ...
    content: `Tecsaro AI is an AI-powered Answer Engine Optimization (AEO) platform that provides tools for:

• Website crawling and content extraction
• Automated prompt generation for AI engine tracking
• Daily AI visibility tracking across ChatGPT, Gemini, and Perplexity
• AEO Visibility Score calculation
• Competitor detection in AI-generated answers
• Recommendations to improve AI answer visibility
• Structured schema generation (FAQ, Organization, Article, Product)

We provide tools, data, and recommendations only. We do not guarantee brand mentions, placements, or visibility outcomes in AI-generated answers.`
  },
  {
    title: "2. Eligibility",
...
• Connect websites you do not own or have permission to manage
• Attempt to reverse-engineer the platform
• Interfere with system security or performance
• Misuse crawling, prompt generation, or tracking features

Violation may result in suspension or termination.`
  },
  {
    title: "6. Content & Schema Responsibility",
    content: `You are fully responsible for:

• How you use the schema and recommendations generated by Tecsaro AI
• Ensuring any content changes you make comply with laws and platform policies
• Reviewing schema and recommendations before implementing them

Tecsaro AI is not responsible for errors, penalties, or damages resulting from the use of generated schema or recommendations.`
  },
  {
...
• You grant us limited rights to crawl and process your website data to provide services`
  },
  {
...
AI engine tracking results may vary due to changes made by third-party AI providers.`
  },
  {
...
• We are not responsible for changes made by AI engine providers that affect visibility
• We are not responsible for AI mention outcomes or brand presence in third-party AI answers
