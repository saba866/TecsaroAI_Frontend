...
export default function BillingPage() {
  ...
  <div className="w-full py-2.5 rounded-lg text-sm font-semibold mb-5 bg-emerald/5 border border-emerald/20 flex items-center justify-center gap-2 cursor-not-allowed select-none">
    <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-emerald/20 text-emerald font-mono">COMING SOON</span>
    <span className="text-emerald/50 text-xs">Pro Plan</span>
  </div>
) : (
  <button
    onClick={() => openCheckout(plan.tier as "starter" | "pro", planInterval)}
