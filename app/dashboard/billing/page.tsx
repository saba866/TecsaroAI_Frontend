...
interface Invoice { id: string; date: string; amount: string; status: string;  invoice_url:  string |null}
interface UsageData {
                ...
                <div className="flex items-center gap-4">
                  ...
                  {inv.invoice_url ? (
                    <a
                      ...
                      className="text-xs text-emerald hover:underline transition-colors"
                    >
                      Download
                    </a>
                  ) : (
