      ...
      try {
        ...
        const poll = async () => {
          ...
          try {
            ...
            // User refreshed mid-flow — already past prompt selection
            if (
              ...
              notified.current = true;
              clearInterval(intervalRef.current);
              onNext(); // jump to where they left off
            }
          } catch { /* silent retry */ }
        };
