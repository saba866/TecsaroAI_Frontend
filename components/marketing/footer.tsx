...
// const socialLinks = [
//   { name: "Twitter",   href: "https://x.com/tecsaroai",                          icon: Twitter   },
//   { name: "LinkedIn",  href: "https://www.linkedin.com/company/tecsaroai/",      icon: Linkedin  },
//   { name: "Facebook",  href: "https://www.facebook.com/tecsaroai",               icon: Facebook  },
//   { name: "Instagram", href: "https://www.instagram.com/tecsaroai",              icon: Instagram },
//   { name: "Youtube",   href: "https://www.youtube.com/@tecsaroai",               icon: Youtube   },
// ]
...
//                 >
//                   <Link href={link.href} className="text-sm text-gray-400 hover:text-white transition-colors relative group">
//                     <span>{link.name}</span>
//                     <motion.span
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8 py-16" ref={ref}>
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-gray-400 mb-6 max-w-xs leading-relaxed">
              Track and optimize your brand's visibility in AI answers — across ChatGPT, Gemini, and Perplexity.
            </p>

            {/* Powered by mini badges */}
            <div className="flex flex-wrap gap-1.5 mb-6">
              {["ChatGPT", "Gemini", "Perplexity"].map((name) => (
                <span
                  key={name}
                  className="px-2 py-0.5 rounded-full bg-white/5 border border-white/10 text-[10px] text-gray-500 font-mono"
                >
                  {name}
                </span>
              ))}
        ...
        >
          ...
          <motion.p
            ...
            transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
          >
            Track and optimize your brand's visibility in AI answers.
          </motion.p>
        </motion.div>
      </div>
    </footer>
