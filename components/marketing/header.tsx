...
//                   />
//                   <span className="relative">Start Free Trail</span>
//                 </Button>
//               </motion.div>
//             </Link>
//           </motion.div>
...
// // Pages whose top section is DARK → white text is safe
// // Add any page slug here that starts with a dark hero
// const DARK_HERO_PAGES = [  "/features", "/about", "/solutions"]
...
//   // isLight = transparent header over a white/light page background
...
//           ? "bg-charcoal/95 backdrop-blur-md border-b border-white/10 shadow-lg"
//           : isLight
//           ? "bg-white/90 backdrop-blur-sm border-b border-gray-200/80 shadow-sm"
//           : "bg-transparent"
//       }`}
//       initial={{ y: -100, opacity: 0 }}
//       animate={{ y: 0,    opacity: 1 }}
...
//                   variant="ghost"
//                   className={isLight
//                     ? "text-gray-700 hover:text-charcoal hover:bg-gray-100"
