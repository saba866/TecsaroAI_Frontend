...
import Link from "next/link"
import { Button } from "@/components/ui/button"
import { ArrowRight, Sparkles, Activity, Shield, Clock } from "lucide-react"
import { motion, useInView, useMotionValue, useSpring } from "framer-motion"
import { useRef, useState } from "react"

const benefits = [
  { icon: Activity, text: "Daily AI answer tracking" },
  { icon: Shield, text: "No credit card required" },
  { icon: Clock, text: "Up and running in minutes" },
]
            ...
            <div className="relative rounded-3xl bg-charcoal p-8 sm:p-12 lg:p-16 overflow-hidden">
              ...
              <div className="relative text-center">
                ...
                <motion.h2
                  ...
                  transition={{ delay: 0.3, duration: 0.6 }}
                >
                  Find out if your brand appears{" "}
                  <motion.span
                    className="relative inline-block"
                    whileHover={{ scale: 1.05 }}
                  >
                ...
                <motion.p
                  ...
                  transition={{ delay: 0.4 }}
                >
                  Connect your website, generate prompts, and get your first AEO Visibility Score across ChatGPT, Gemini, and Perplexity — all in minutes.
                </motion.p>
